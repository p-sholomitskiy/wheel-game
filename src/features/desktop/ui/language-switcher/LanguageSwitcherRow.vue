...
.language-switcher-row--trigger .language-switcher-row__code {
  overflow: hidden;
...
.language-switcher-row__chevron-spacer {
  flex-shrink: 0;
  width: 10px;
  height: 10px;
}

.language-switcher-row__chevron-svg {
  display: block;
  transition: transform 0.2s ease;
}

.language-switcher-row__chevron-svg--open {
